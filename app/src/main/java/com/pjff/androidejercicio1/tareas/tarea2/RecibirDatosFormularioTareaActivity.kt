...
class RecibirDatosFormularioTareaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_recibir_datos_formulario_tarea)
        ...
        val receivedMessage3:String = intent.extras?.getString("EXTRA_MESSAGE3").orEmpty()
        val receivedMessage4:String = intent.extras?.getString("EXTRA_MESSAGE4").orEmpty()
        ...
        val receivedMessage7:String = intent.extras?.getString("EXTRA_MESSAGE7").orEmpty()
